...
class Flat(models.Model):
    ...
    liked_by = models.ManyToManyField(
        User, verbose_name="Кло лайкнул", related_name='flats_liked',
        blank=True, db_index=True)
...
class Owner(models.Model):
    name = models.CharField(
        verbose_name="ФИО владельца", max_length=200, db_index=True)
    ...
    flats = models.ManyToManyField(
        "Flat", related_name='flat_owners', db_index=True, blank=True,
